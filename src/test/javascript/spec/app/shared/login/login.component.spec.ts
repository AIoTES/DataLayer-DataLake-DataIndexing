...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: SimLoginModalComponent;
        let fixture: ComponentFixture<SimLoginModalComponent>;
        ...
        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    ...
                    .overrideTemplate(SimLoginModalComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(SimLoginModalComponent);
